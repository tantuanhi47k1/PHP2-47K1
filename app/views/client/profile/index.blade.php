                    ...
                    <div class="card-body p-3 profile-sidebar">
                        <nav class="nav flex-column gap-1">
                            ...
                            <a href="/profile?tab=orders"
                                class="nav-link {{ isset($tab) && $tab == 'orders' ? 'active' : '' }}">
                                <i class="bi bi-box-seam"></i> Lịch sử đơn hàng
                            </a>
                            <a href="/profile?tab=password"
                                class="nav-link {{ isset($tab) && $tab == 'password' ? 'active' : '' }}">
            ...
            <div class="col-lg-9">
                @if (isset($_SESSION['success']))
                    <div class="alert alert-success alert-dismissible fade show rounded-3 shadow-sm">
                        <i class="bi bi-check-circle-fill me-2"></i> {{ $_SESSION['success'] }} <button type="button"
                ...
                @if (isset($_SESSION['error']))
                    <div class="alert alert-danger alert-dismissible fade show rounded-3 shadow-sm">
                        <i class="bi bi-exclamation-triangle-fill me-2"></i> {{ $_SESSION['error'] }} <button type="button"
                            class="btn-close" data-bs-dismiss="alert"></button>
                    </div>
                            ...
                            <form action="/profile/updateInfo" method="POST" enctype="multipart/form-data">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6"><label
                                            ...
                                            class="form-control bg-light" value="{{ $user['email'] }}" readonly disabled>
                                    </div>
                                    ...
                                    <table class="table table-hover align-middle">
                                        ...
                                        <tbody>
                                            @foreach ($orders as $order)
                                                <tr>
                                                    <td><span class="fw-bold text-primary">#{{ $order['id'] }}</span>
                                                    </td>
                                                        ...
                                                        <div class="d-flex justify-content-end gap-2">
                                                            ...
                                                            @if ($order['status'] == 1)
                                                                <a href="javascript:void(0)"
                                                                    data-url="/profile/cancelOrder/{{ $order['id'] }}"
                                                            ...
                                                            @if ($order['status'] == 3)
                                                                <a href="/profile/reorder/{{ $order['id'] }}"
