            ...
            <div class="alert alert-danger shadow-sm border-0 mb-4">
                <ul class="mb-0">
                    <?php $__currentLoopData = $errors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li><i class="bi bi-exclamation-circle me-2"></i><?php echo e($e); ?></li>
                        ...
                        <div class="card-body p-4">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="fullname" class="form-control bg-light"
                                        ...
                                        value="<?php echo e($old['fullname'] ?? ($user['full_name'] ?? '')); ?>" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label fw-semibold">Số điện thoại <span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="phone" class="form-control bg-light"
                                        placeholder="09xxxx..." value="<?php echo e($old['phone'] ?? ($user['phone'] ?? '')); ?>"
                                        required>

                                    <?php if(isset($user) && empty($user['phone'])): ?>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" name="email" class="form-control bg-light"
                                    placeholder="email@example.com" value="<?php echo e($old['email'] ?? ($user['email'] ?? '')); ?>">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="note" class="form-control" rows="2" placeholder="Ghi chú về đơn hàng..."><?php echo e($old['note'] ?? ''); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layout.clientLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH G:\laragon\www\PHP2-47K1\app\views/client/checkout/index.blade.php ENDPATH**/ ?>