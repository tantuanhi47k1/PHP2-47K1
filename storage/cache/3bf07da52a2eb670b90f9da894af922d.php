                    ...
                    <div class="card h-100 shadow-sm border-0 product-card position-relative">
                        ...
                        <div class="card-body text-center d-flex flex-column">
                            <h6 class="text-truncate fw-bold mb-2">
                                <a href="/product/detail/<?php echo e($item['id']); ?>" class="text-decoration-none text-dark stretched-link">
                                    <?php echo e($item['name'] ?? 'Sản phẩm chưa đặt tên'); ?>

                                </a>
                            </h6>
                            
                            <div class="text-primary fw-bold mb-3 fs-5">
                                <?php echo e(number_format($item['base_price'] ?? 0, 0, ',', '.')); ?>đ
                            </div>
                            
                            <div class="mt-auto">
                                <a href="/product/detail/<?php echo e($item['id']); ?>" class="btn btn-outline-primary rounded-pill w-100 btn-sm fw-bold position-relative" style="z-index: 2;">
                                    Xem chi tiết
                                </a>
                            </div>
                        </div>
...
<?php echo $__env->make('layout.clientLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\php2_tantuan47k1\app\views/client/favorite/index.blade.php ENDPATH**/ ?>