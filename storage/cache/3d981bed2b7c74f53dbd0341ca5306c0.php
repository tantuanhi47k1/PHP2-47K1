                            ...
                            <div class="col-md-8">
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="number" name="base_price" class="form-control" placeholder="500000"
                                            value="<?= htmlspecialchars($old['base_price'] ?? '') ?>">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="short_description" class="form-control" rows="2"><?= htmlspecialchars($old['short_description'] ?? '') ?></textarea>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Mô tả chi tiết</label>
                                    <textarea name="description" class="form-control" rows="5"><?= htmlspecialchars($old['description'] ?? '') ?></textarea>
                                </div>
                            </div>
