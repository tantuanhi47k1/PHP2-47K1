    ...
    <div class="container">
        ...
        <div class="d-flex align-items-center mb-4">
            ...
            <span class="badge bg-primary bg-opacity-10 text-primary rounded-pill ms-3 fs-6">
                <?php echo e(isset($cart) ? count($cart) : 0); ?> sản phẩm
            </span>
        </div>
                                        ...
                                        <div class="col-6 d-flex align-items-center">
                                            ...
                                            <div class="ms-3">
                                                <h6 class="fw-bold mb-1 text-truncate" style="max-width: 200px;">
                                                    <a href="/product/detail/<?php echo e($id); ?>" class="text-dark text-decoration-none">
                                                        <?php echo e($item['name']); ?>

                                                    </a>
                                                </h6>
                                                <div class="small text-muted mb-2"><?php echo e(number_format($item['price'])); ?>đ</div>
                                                <a href="/cart/remove/<?php echo e($id); ?>" class="btn-remove p-0 border-0 bg-transparent" onclick="return confirm('Bạn chắc chắn muốn xóa sản phẩm này?')">
                    ...
                    <div class="col-lg-4">
                        <div class="card summary-card p-4 bg-white">
                            ...
                            <div class="d-flex justify-content-between mb-3">
                                ...
                                <span class="fw-bold"><?php echo e(number_format($totalPrice)); ?>đ</span>
                            </div>
                            <div class="d-flex justify-content-between mb-3">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <span class="fw-bold fs-4 text-primary"><?php echo e(number_format($totalPrice)); ?>đ</span>
                            </div>
