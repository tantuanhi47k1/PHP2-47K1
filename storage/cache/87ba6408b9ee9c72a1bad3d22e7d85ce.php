                ...
                <div class="card h-100 border-0 shadow-sm product-card">
                    ...
                    <div class="position-relative overflow-hidden">
                        <a href="/product/detail/<?php echo e($p['id']); ?>">
                            <img src="/public/image/product/<?php echo e($p['image']); ?>" class="card-img-top" alt="<?php echo e($p['name']); ?>"
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center">
                            <?php if($p['sale_price'] > 0): ?>
                                <span class="fw-bold text-danger me-2"><?php echo e(number_format($p['sale_price'])); ?>đ</span>
                                <small class="text-muted text-decoration-line-through"><?php echo e(number_format($p['price'])); ?>đ</small>
                            <?php else: ?>
                                <span class="fw-bold text-dark"><?php echo e(number_format($p['price'])); ?>đ</span>
                            <?php endif; ?>
                        </div>
                    </div>
