...
<?php $__env->startSection('content'); ?>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    ...
                    <div class="d-flex gap-3">
                        <a href="/product" class="btn btn-primary btn-lg px-4 rounded-pill fw-bold shadow">Mua Ngay</a>
    ...
    <div class="container mb-5" id="featured">
        <div class="d-flex justify-content-between align-items-end mb-4 px-2">
            ...
            <a href="/product" class="btn btn-link text-primary fw-bold text-decoration-none p-0">Xem tất cả <i
