        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                ...
                <ul class="list-unstyled small text-secondary">
                    <li class="mb-1"><i class="bi bi-geo-alt-fill me-2 text-primary"></i> 123 Đường Nguyễn Tất Thành, Phường BMT, Tỉnh Đăk Lăk</li>
                    <li class="mb-1"><i class="bi bi-envelope-fill me-2 text-primary"></i> support@techhub.com</li>
                    <li class="mb-1"><i class="bi bi-telephone-fill me-2 text-primary"></i> 1900 7799 (8:00 - 22:00)</li>
                </ul>
            </div>
        </div>
