            ...
            <div class="card border-0 shadow-sm rounded-4 h-100">
                <div class="card-body p-4 text-center border-bottom">
                    ...
                    <div class="avatar-wrapper mb-3">
                        <?php if(!empty($user['avatar'])): ?>
                            ...
                            ?>
                            <img src="<?php echo e($src); ?>" class="avatar-img" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                ...
                <div class="card-body p-3 profile-sidebar">
                    <nav class="nav flex-column gap-1">
                        ...
                        <a href="/profile?tab=orders" class="nav-link <?php echo e((isset($tab) && $tab == 'orders') ? 'active' : ''); ?>">
                            <i class="bi bi-box-seam"></i> Lịch sử đơn hàng
                        </a>
                        <a href="/profile?tab=password" class="nav-link <?php echo e((isset($tab) && $tab == 'password') ? 'active' : ''); ?>">
        ...
        <div class="col-lg-9">
            <?php if(isset($_SESSION['success'])): ?>
                <div class="alert alert-success alert-dismissible fade show rounded-3 shadow-sm">
                    <i class="bi bi-check-circle-fill me-2"></i> <?php echo e($_SESSION['success']); ?> <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                </div>
                <?php unset($_SESSION['success']); ?>
            <?php endif; ?>
            <?php if(isset($_SESSION['error'])): ?>
                <div class="alert alert-danger alert-dismissible fade show rounded-3 shadow-sm">
                    <i class="bi bi-exclamation-triangle-fill me-2"></i> <?php echo e($_SESSION['error']); ?> <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                </div>
                ...
                <div class="card-body p-4 p-md-5">
                    ...
                    <?php if(!isset($tab) || $tab == 'info'): ?>
                        ...
                        <form action="/profile/updateInfo" method="POST" enctype="multipart/form-data">
                            <div class="row g-3">
                                <div class="col-md-6"><label class="form-label fw-bold small text-muted">Họ và tên</label><input type="text" name="fullname" class="form-control" value="<?php echo e($user['full_name']); ?>" required></div>
                                <div class="col-md-6"><label class="form-label fw-bold small text-muted">Email</label><input type="email" class="form-control bg-light" value="<?php echo e($user['email']); ?>" readonly disabled></div>
                                <div class="col-md-6"><label class="form-label fw-bold small text-muted">Số điện thoại</label><input type="text" name="phone" class="form-control" value="<?php echo e($user['phone'] ?? ''); ?>"></div>
                                <div class="col-md-12"><label class="form-label fw-bold small text-muted">Địa chỉ</label><input type="text" name="address" class="form-control" value="<?php echo e($user['address'] ?? ''); ?>"></div>
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <a href="/profile/order/<?php echo e($order['id']); ?>" class="btn btn-sm btn-outline-primary rounded-pill">Xem chi tiết</a>
                                                </td>
                                            </tr>
...
<?php echo $__env->make('layout.clientLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\php2_tantuan47k1\app\views/client/profile/index.blade.php ENDPATH**/ ?>