                    ...
                    <form action="/variant/store/<?= $product['id'] ?>" method="POST" enctype="multipart/form-data">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="sku" class="form-control" placeholder="VD: IP15-BLACK-128" required>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                ...
                                <small class="text-muted">Chọn ảnh đặc trưng cho màu sắc hoặc phiên bản này.</small>
...
<?php echo $__env->make('layout.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\php2_tantuan47k1\app\views/admin/variant/create.blade.php ENDPATH**/ ?>