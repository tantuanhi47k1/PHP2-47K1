                    ...
                    <div class="card-body p-4">
                        <form action="/color/store" method="POST">                        
                            <div class="mb-4">
                                ...
                                <input type="text" 
                                       class="form-control form-control-lg border-2 <?php if(isset($errors['name'])): ?> is-invalid <?php endif; ?>" 
                                       id="name" 
                                       name="name" 
...
<?php echo $__env->make('layout.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH G:\laragon\www\PHP2-47K1\app\views/admin/product/color/create.blade.php ENDPATH**/ ?>