...
<style>
    .content-wrapper { background-color: #f4f7f6; min-height: 100vh; }

    .card { border: none; border-radius: 12px; transition: all 0.3s ease; }
    .card-header { border-bottom: 1px solid #edf2f7 !important; padding: 1.25rem !important; }
    .card-title { font-size: 1.1rem; color: #2d3748; margin-bottom: 0; }
    ...
    .attr-row:hover { background-color: #fcfdfe; }
    ...
    .delete-val-btn:hover { color: #e53e3e; }
    ...
    .quick-add-input { border: none !important; box-shadow: none !important; font-size: 0.85rem; }
    .quick-add-btn { border-radius: 0 !important; padding-left: 15px; padding-right: 15px; }
    ...
    .btn-primary { border-radius: 8px; padding: 0.6rem 1rem; background-color: #3182ce; border: none; }
...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4 px-2">
        <div>
            <h3 class="fw-bold text-dark mb-1">Cấu hình thuộc tính</h3>
            <p class="text-muted small mb-0">Quản lý Màu sắc, Kích thước, RAM và các đặc tính sản phẩm.</p>
        </div>
    </div>
                ...
                <div class="card-body py-4">
                    <form action="/attribute/storeAttribute" method="POST">
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="VD: Màu sắc, Dung lượng..." required>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table align-middle mb-0">
                            <thead>
                                <tr>
                                    <th class="ps-4" style="width: 25%;">Tên Thuộc Tính</th>
                                    <th style="width: 45%;">Giá Trị</th>
                                    <th style="width: 20%;">Thêm Nhanh</th>
                            ...
                            <tbody>
                                ...
                                <?php else: ?>
                                    ...
                                    <tr class="attr-row">
                                        ...
                                        <td>
                                            <form action="/attribute/storeValue" method="POST" class="input-group quick-add-group">
                                                <input type="hidden" name="attribute_id" value="<?php echo e($attr['id']); ?>">
                                                <input type="text" name="value" class="form-control quick-add-input" placeholder="VD: Đỏ..." required>
